...
const trainDataUrl = 'file:///Users/felix/code/2020/tfjs-practice/data/fashionMnist/fashion-mnist_train.csv';
const testDataUrl = 'file:///Users/felix/code/2020/tfjs-practice/data/fashionMnist/fashion-mnist_test.csv';
...
const loadData = function (dataUrl: string) {
  // normalize data values between 0-1
  const normalize = ({ xs, ys }) => {
    return {
      xs: Object.values(xs).map((x: number) => x / 255),
      ys: ys.label
    };
  };
...
const run = async function () {
  ...
  const saveModelPath = 'file:///Users/felix/code/2020/tfjs-practice/models';
